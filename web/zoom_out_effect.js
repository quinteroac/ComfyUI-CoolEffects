...
export const EXTENSION_NAME = "Comfy.CoolEffects.ZoomOutEffect";
const ZOOM_OUT_PARAM_SPECS = Object.freeze([
    Object.freeze({
    ...
    Object.freeze({
        widget_name: "zoom_speed",
        uniform_name: "u_zoom_speed",
        default_value: 0.6,
    }),
]);

export async function mount_zoom_out_effect_widget_for_node({
    node,
    ...
    return mount_effect_node_widget(node, "zoom_out", ZOOM_OUT_PARAM_SPECS, {
        document_ref,
        shader_loader,
...
export function register_comfy_extension(
    ...
    app_ref.registerExtension({
        ...
        async beforeRegisterNodeDef(nodeType, nodeData) {
            if (nodeData?.name !== "CoolZoomOutEffect") {
                return;
            }
            ...
            nodeType.prototype.onNodeCreated = async function onNodeCreated() {
                ...
                await mount_zoom_out_effect_widget_for_node({
                    node: this,
                    document_ref,
                    shader_loader,
                    request_animation_frame,
            ...
            nodeType.prototype.onRemoved = function onRemoved() {
                stop_effect_node_widget_preview(this, "zoom_out");
