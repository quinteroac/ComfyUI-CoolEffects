...
const ZOOM_PULSE_PARAM_SPECS = Object.freeze([
    Object.freeze({
        widget_name: "pulse_amp",
        uniform_name: "u_pulse_amp",
        default_value: 0.06,
    }),
    Object.freeze({
        widget_name: "pulse_speed",
        uniform_name: "u_pulse_speed",
        default_value: 3.0,
    }),
]);
...
export async function mount_zoom_pulse_effect_widget_for_node({
    ...
    return mount_effect_node_widget(node, "zoom_pulse", ZOOM_PULSE_PARAM_SPECS, {
        document_ref,
        shader_loader,
    ...
    app_ref.registerExtension({
        ...
        async beforeRegisterNodeDef(nodeType, nodeData) {
            ...
            nodeType.prototype.onRemoved = function onRemoved() {
                stop_effect_node_widget_preview(this, "zoom_pulse");
