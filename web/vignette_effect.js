...
export const EXTENSION_NAME = "Comfy.CoolEffects.VignetteEffect";
export const VIGNETTE_PARAM_SPECS = Object.freeze([
    Object.freeze({
...
export function apply_vignette_uniform_from_widget(node, widget_name, widget_value) {
...
export async function mount_vignette_effect_widget_for_node({
    node,
    ...
    return mount_effect_node_widget(node, "vignette", VIGNETTE_PARAM_SPECS, {
        document_ref,
        shader_loader,
...
export function register_comfy_extension(
    ...
    app_ref.registerExtension({
        ...
        async beforeRegisterNodeDef(nodeType, nodeData) {
            if (nodeData?.name !== "CoolVignetteEffect") {
                return;
            }
            ...
            nodeType.prototype.onNodeCreated = async function onNodeCreated() {
                ...
                await mount_vignette_effect_widget_for_node({
                    node: this,
                    document_ref,
                    shader_loader,
                    request_animation_frame,
            ...
            nodeType.prototype.onRemoved = function onRemoved() {
                stop_effect_node_widget_preview(this, "vignette");
            ...
            nodeType.prototype.onWidgetChanged = function onWidgetChanged() {
                ...
                apply_vignette_uniform_from_widget(this, widget_name, widget_value);
            };
        },
    });
