...
export const EXTENSION_NAME = "Comfy.CoolEffects.ZoomInEffect";
const ZOOM_IN_PARAM_SPECS = Object.freeze([
    Object.freeze({
...
export async function mount_zoom_in_effect_widget_for_node({
    node,
    ...
    return mount_effect_node_widget(node, "zoom_in", ZOOM_IN_PARAM_SPECS, {
        document_ref,
        shader_loader,
...
export function register_comfy_extension(
    ...
    app_ref.registerExtension({
        ...
        async beforeRegisterNodeDef(nodeType, nodeData) {
            if (nodeData?.name !== "CoolZoomInEffect") {
                return;
            }
            ...
            nodeType.prototype.onNodeCreated = async function onNodeCreated() {
                ...
                await mount_zoom_in_effect_widget_for_node({
                    node: this,
                    document_ref,
                    shader_loader,
                    request_animation_frame,
            ...
            nodeType.prototype.onRemoved = function onRemoved() {
                stop_effect_node_widget_preview(this, "zoom_in");
