...
export const EXTENSION_NAME = "Comfy.CoolEffects.PixelateEffect";
export const PIXELATE_PARAM_SPECS = Object.freeze([
    Object.freeze({
...
export function apply_pixelate_uniform_from_widget(node, widget_name, widget_value) {
...
export async function mount_pixelate_effect_widget_for_node({
    node,
    ...
    return mount_effect_node_widget(node, "pixelate", PIXELATE_PARAM_SPECS, {
        document_ref,
        shader_loader,
...
export function register_comfy_extension(
    ...
    app_ref.registerExtension({
        ...
        async beforeRegisterNodeDef(nodeType, nodeData) {
            if (nodeData?.name !== "CoolPixelateEffect") {
                return;
            }
            ...
            nodeType.prototype.onNodeCreated = async function onNodeCreated() {
                ...
                await mount_pixelate_effect_widget_for_node({
                    node: this,
                    document_ref,
                    shader_loader,
                    request_animation_frame,
            ...
            nodeType.prototype.onRemoved = function onRemoved() {
                stop_effect_node_widget_preview(this, "pixelate");
            ...
            nodeType.prototype.onWidgetChanged = function onWidgetChanged() {
                ...
                apply_pixelate_uniform_from_widget(this, widget_name, widget_value);
            };
        },
    });
