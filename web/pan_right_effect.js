...
export const EXTENSION_NAME = "Comfy.CoolEffects.PanRightEffect";
const PAN_RIGHT_PARAM_SPECS = Object.freeze([
    Object.freeze({
        widget_name: "speed",
...
export async function mount_pan_right_effect_widget_for_node({
    node,
    ...
    return mount_effect_node_widget(node, "pan_right", PAN_RIGHT_PARAM_SPECS, {
        document_ref,
        shader_loader,
...
export function register_comfy_extension(
    ...
    app_ref.registerExtension({
        ...
        async beforeRegisterNodeDef(nodeType, nodeData) {
            if (nodeData?.name !== "CoolPanRightEffect") {
                return;
            }
            ...
            nodeType.prototype.onNodeCreated = async function onNodeCreated() {
                ...
                await mount_pan_right_effect_widget_for_node({
                    node: this,
                    document_ref,
                    shader_loader,
                    request_animation_frame,
            ...
            nodeType.prototype.onRemoved = function onRemoved() {
                stop_effect_node_widget_preview(this, "pan_right");
