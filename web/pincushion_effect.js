...
export const EXTENSION_NAME = "Comfy.CoolEffects.PincushionEffect";
export const PINCUSHION_PARAM_SPECS = Object.freeze([
    Object.freeze({
...
export function apply_pincushion_uniform_from_widget(node, widget_name, widget_value) {
...
export async function mount_pincushion_effect_widget_for_node({
    node,
    ...
    return mount_effect_node_widget(node, "pincushion", PINCUSHION_PARAM_SPECS, {
        document_ref,
        shader_loader,
...
export function register_comfy_extension(
    ...
    app_ref.registerExtension({
        ...
        async beforeRegisterNodeDef(nodeType, nodeData) {
            if (nodeData?.name !== "CoolPincushionEffect") {
                return;
            }
            ...
            nodeType.prototype.onNodeCreated = async function onNodeCreated() {
                ...
                await mount_pincushion_effect_widget_for_node({
                    node: this,
                    document_ref,
                    shader_loader,
                    request_animation_frame,
            ...
            nodeType.prototype.onRemoved = function onRemoved() {
                stop_effect_node_widget_preview(this, "pincushion");
            ...
            nodeType.prototype.onWidgetChanged = function onWidgetChanged() {
                ...
                apply_pincushion_uniform_from_widget(this, widget_name, widget_value);
            };
        },
    });
