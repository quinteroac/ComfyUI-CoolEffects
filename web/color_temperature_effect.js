...
export const EXTENSION_NAME = "Comfy.CoolEffects.ColorTemperatureEffect";
export const COLOR_TEMPERATURE_PARAM_SPECS = Object.freeze([
    Object.freeze({
...
export function apply_color_temperature_uniform_from_widget(
    node,
    widget_name,
    widget_value,
) {
...
export async function mount_color_temperature_effect_widget_for_node({
    node,
...
export function register_comfy_extension(
    ...
    app_ref.registerExtension({
        ...
        async beforeRegisterNodeDef(nodeType, nodeData) {
            if (nodeData?.name !== "CoolColorTemperatureEffect") {
                return;
            }
            ...
            nodeType.prototype.onNodeCreated = async function onNodeCreated() {
                ...
                await mount_color_temperature_effect_widget_for_node({
                    node: this,
                    document_ref,
                    shader_loader,
                    request_animation_frame,
            ...
            nodeType.prototype.onRemoved = function onRemoved() {
                stop_effect_node_widget_preview(this, "color_temperature");
