...
export const EXTENSION_NAME = "Comfy.CoolEffects.CurvesEffect";
export const CURVES_PARAM_SPECS = Object.freeze([
    Object.freeze({
        widget_name: "lift",
        uniform_name: "u_lift",
        default_value: 0.0,
...
export function apply_curves_uniform_from_widget(node, widget_name, widget_value) {
...
export async function mount_curves_effect_widget_for_node({
    node,
    ...
    return mount_effect_node_widget(node, "curves", CURVES_PARAM_SPECS, {
        document_ref,
        shader_loader,
...
export function register_comfy_extension(
    ...
    app_ref.registerExtension({
        ...
        async beforeRegisterNodeDef(nodeType, nodeData) {
            if (nodeData?.name !== "CoolCurvesEffect") {
                return;
            }
            ...
            nodeType.prototype.onNodeCreated = async function onNodeCreated() {
                ...
                await mount_curves_effect_widget_for_node({
                    node: this,
                    document_ref,
                    shader_loader,
                    request_animation_frame,
            ...
            nodeType.prototype.onRemoved = function onRemoved() {
                stop_effect_node_widget_preview(this, "curves");
            ...
            nodeType.prototype.onWidgetChanged = function onWidgetChanged() {
                ...
                apply_curves_uniform_from_widget(this, widget_name, widget_value);
            };
        },
    });
