...
export const EXTENSION_NAME = "Comfy.CoolEffects.CrtPixelGridEffect";
export const CRT_PIXEL_GRID_PARAM_SPECS = Object.freeze([
    Object.freeze({
...
export function apply_crt_pixel_grid_uniform_from_widget(node, widget_name, widget_value) {
...
export async function mount_crt_pixel_grid_effect_widget_for_node({
    node,
    ...
    return mount_effect_node_widget(node, "crt_pixel_grid", CRT_PIXEL_GRID_PARAM_SPECS, {
        document_ref,
        shader_loader,
...
export function register_comfy_extension(
    ...
    app_ref.registerExtension({
        ...
        async beforeRegisterNodeDef(nodeType, nodeData) {
            if (nodeData?.name !== "CoolCrtPixelGridEffect") {
                return;
            }
            ...
            nodeType.prototype.onNodeCreated = async function onNodeCreated() {
                ...
                await mount_crt_pixel_grid_effect_widget_for_node({
                    node: this,
                    document_ref,
                    shader_loader,
                    request_animation_frame,
            ...
            nodeType.prototype.onRemoved = function onRemoved() {
                stop_effect_node_widget_preview(this, "crt_pixel_grid");
            ...
            nodeType.prototype.onWidgetChanged = function onWidgetChanged() {
                ...
                apply_crt_pixel_grid_uniform_from_widget(this, widget_name, widget_value);
            };
        },
    });
