...
export const EXTENSION_NAME = "Comfy.CoolEffects.DollyOutEffect";
const DOLLY_OUT_PARAM_SPECS = Object.freeze([
    Object.freeze({
        widget_name: "dolly_strength",
        uniform_name: "u_dolly_strength",
        default_value: 0.35,
    }),
    Object.freeze({
        widget_name: "dolly_speed",
        uniform_name: "u_dolly_speed",
        default_value: 0.7,
    }),
    Object.freeze({
        widget_name: "focus_x",
        uniform_name: "u_focus_x",
        default_value: 0.5,
    }),
    Object.freeze({
        widget_name: "focus_y",
        uniform_name: "u_focus_y",
        default_value: 0.5,
    }),
]);

export async function mount_dolly_out_effect_widget_for_node({
    node,
    ...
    return mount_effect_node_widget(node, "dolly_out", DOLLY_OUT_PARAM_SPECS, {
        document_ref,
        shader_loader,
...
export function register_comfy_extension(
    ...
    app_ref.registerExtension({
        ...
        async beforeRegisterNodeDef(nodeType, nodeData) {
            if (nodeData?.name !== "CoolDollyOutEffect") {
                return;
            }
            ...
            nodeType.prototype.onNodeCreated = async function onNodeCreated() {
                ...
                await mount_dolly_out_effect_widget_for_node({
                    node: this,
                    document_ref,
                    shader_loader,
                    request_animation_frame,
            ...
            nodeType.prototype.onRemoved = function onRemoved() {
                stop_effect_node_widget_preview(this, "dolly_out");
