...
export const EXTENSION_NAME = "Comfy.CoolEffects.WaterDropsEffect";
const WATER_DROPS_PARAM_SPECS = Object.freeze([
    Object.freeze({
        widget_name: "drop_density",
        uniform_name: "u_drop_density",
        default_value: 60.0,
    }),
    Object.freeze({
        widget_name: "drop_size",
        uniform_name: "u_drop_size",
        default_value: 0.08,
    }),
    Object.freeze({
        widget_name: "fall_speed",
        uniform_name: "u_fall_speed",
        default_value: 1.0,
    }),
    Object.freeze({
        widget_name: "refraction_strength",
        uniform_name: "u_refraction_strength",
        default_value: 0.3,
    }),
    Object.freeze({
        widget_name: "gravity",
        uniform_name: "u_gravity",
        default_value: 1.0,
    }),
    Object.freeze({
        widget_name: "wind",
...
export async function mount_water_drops_effect_widget_for_node({
    ...
    return mount_effect_node_widget(node, "water_drops", WATER_DROPS_PARAM_SPECS, {
        document_ref,
        shader_loader,
...
export function register_comfy_extension(
    ...
    app_ref.registerExtension({
        ...
        async beforeRegisterNodeDef(nodeType, nodeData) {
            if (nodeData?.name !== "CoolWaterDropsEffect") {
                return;
            }
            ...
            nodeType.prototype.onNodeCreated = async function onNodeCreated() {
                ...
                await mount_water_drops_effect_widget_for_node({
                    node: this,
                    document_ref,
                    shader_loader,
                    request_animation_frame,
            ...
            nodeType.prototype.onRemoved = function onRemoved() {
                stop_effect_node_widget_preview(this, "water_drops");
