...
def test_default_params_contains_original_defaults_for_all_effects():
    ...
    assert module.DEFAULT_PARAMS["frosted_glass"] == {
    ...
    assert module.DEFAULT_PARAMS["pan_right"] == {
        "u_speed": 0.1,
        "u_origin_x": 0.0,
        "u_origin_y": 0.0,
    }
    assert module.DEFAULT_PARAMS["pan_up"] == {
        "u_speed": 0.1,
        "u_origin_x": 0.0,
        "u_origin_y": 0.0,
    }
    assert module.DEFAULT_PARAMS["pan_down"] == {
        "u_speed": 0.1,
        "u_origin_x": 0.0,
        "u_origin_y": 0.0,
    }
