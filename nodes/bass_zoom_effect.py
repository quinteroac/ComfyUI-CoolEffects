"""ComfyUI dedicated Bass Zoom effect node."""
...
_EFFECT_PARAMS_SPEC = importlib.util.spec_from_file_location(
    "cool_effects_effect_params_for_bass_zoom_effect", _EFFECT_PARAMS_PATH
)
...
class CoolBassZoomEffect:
    ...
    def execute(self, zoom_strength, smoothing):
        return (
            build_effect_params(
                "bass_zoom",
                {
