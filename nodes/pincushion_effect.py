"""ComfyUI dedicated Pincushion effect node."""
...
_EFFECT_PARAMS_SPEC = importlib.util.spec_from_file_location(
    "cool_effects_effect_params_for_pincushion_effect", _EFFECT_PARAMS_PATH
)
...
class CoolPincushionEffect:
    ...
    def execute(self, strength, zoom):
        return (
            build_effect_params(
                "pincushion",
                {
