"""ComfyUI dedicated Color Temperature effect node."""
...
_EFFECT_PARAMS_SPEC = importlib.util.spec_from_file_location(
    "cool_effects_effect_params_for_color_temperature_effect", _EFFECT_PARAMS_PATH
)
...
class CoolColorTemperatureEffect:
    @classmethod
    def INPUT_TYPES(cls):
        return {
            "required": {
    ...
    def execute(self, temperature, tint):
        return (
            build_effect_params(
                "color_temperature",
                {
