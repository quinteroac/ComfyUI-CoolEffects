"""ComfyUI dedicated CRT Pixel Grid effect node."""
...
_EFFECT_PARAMS_SPEC = importlib.util.spec_from_file_location(
    "cool_effects_effect_params_for_crt_pixel_grid_effect", _EFFECT_PARAMS_PATH
)
...
class CoolCrtPixelGridEffect:
    ...
    def execute(self, pixel_size, grid_strength, scanline_strength):
        return (
            build_effect_params(
                "crt_pixel_grid",
                {
                    "u_pixel_size": pixel_size,
                    "u_grid_strength": grid_strength,
                    "u_scanline_strength": scanline_strength,
                },
            ),
        )
